...
@implementation NSDictionary (AACategory)
- (NSString *)aa_dictionaryToJson {
    return [NSDictionary aa_dictionaryToJson:self];
}

+ (NSString *)aa_dictionaryToJson:(NSDictionary *)dictionary {
    NSString *json     = nil;
    NSError  *error    = nil;
...
+ (NSDictionary *)aa_dictionaryWithJsonString:(NSString *)jsonString {
